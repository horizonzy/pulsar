...
public class MetadataTransactionTest extends BaseMetadataStoreTest {
    ...
    public void testZkTransaction(String provider, Supplier<String> supplier) throws Exception {
        @Cleanup
        ...
        // batch put
        {
            OpPut opPut1 = new OpPut("/test1", "value1".getBytes(StandardCharsets.UTF_8), Optional.empty(),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut2 = new OpPut("/test2", "value2".getBytes(StandardCharsets.UTF_8), Optional.empty(),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut3 = new OpPut("/test3", "value3".getBytes(StandardCharsets.UTF_8), Optional.empty(),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut4 = new OpPut("/test4", "value4".getBytes(StandardCharsets.UTF_8), Optional.empty(),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut5 = new OpPut("/test5", "value5".getBytes(StandardCharsets.UTF_8), Optional.empty(),
                    EnumSet.noneOf(CreateOption.class));
            ...
            ((AbstractBatchedMetadataStore) store).batchOperation(ops);
        ...
        {
            OpPut opPut1 = new OpPut("/test1", "value1".getBytes(StandardCharsets.UTF_8), Optional.of(0L),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut2 = new OpPut("/test2", "value2".getBytes(StandardCharsets.UTF_8), Optional.of(0L),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut3 = new OpPut("/test3", "value3".getBytes(StandardCharsets.UTF_8), Optional.of(0L),
                    EnumSet.noneOf(CreateOption.class));
            OpPut opPut4 = new OpPut("/test4", "value4".getBytes(StandardCharsets.UTF_8), Optional.of(0L),
                    EnumSet.noneOf(CreateOption.class));
            ...
            Assert.assertEquals(MetadataStoreException.BadVersionException.class, ex.get().getCause().getClass());
        }
